...
:*:rdt`t::
  ...
  hr = %A_hour%
  min = %A_min%
  rdatetime := yr mm dd "_" hr min
  SendInput,{Raw}%rdatetime%
return
;;;;;;;;
:*:sdate`t::
  yr = %A_YYYY%
...
SendInput,{Raw}
(
18-2260,01/c40/démonstrateur dépalettisation chez GSK -
)
SendInput,{Raw}%A_space%
Return
:*:prcop`t::
...
SendInput,{Raw}
(
21-2596/c40/Waak - Vraag cobotschuren -
)
SendInput,{Raw}%A_space%
Return
:*:cmepro`t::
SendInput,{Raw}
(
21-2659/c40/automatisch 3-D robotlassen van aluminium voor E-fietsen en brievenbussen - 
)
SendInput,{Raw}%A_space%
Return
:*:terpro`t::
...
SendInput,{Raw}
(
Eveneens de beste wensen voor 2022!
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
Best wishes for 2022 to you too!
)
SendInput,{Raw}%A_space%
Return
:*:bwe`t::
...
SendInput,{Raw}
(
22-1036/c40/exmore - interesse cobot -schroeven -visie, -bin-picking -
)
SendInput,{Raw}%A_space%
Return
:*:bgm`t::
...
SendInput,{Raw}
(
Offline Robot Programmeer Software
)
SendInput,{Raw}%A_space%
Return
:*:gpw`t::
SendInput,{Raw}
(
groeten en alvast prettig weekend!
Jan.
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
22-1137/c40/Interesse MQTT sensoren, scanners - 
)
SendInput,{Raw}%A_space%
Return
:*:db`t::
...
SendInput,{Raw}
(
22-1301/c40/Provan, robot-to-robot projectidee -
)
SendInput,{Raw}%A_space%
Return
:*:trintags`t::
SendInput,{Raw}
(
#trinitydih @TrinityRoboticsDIHs @Malmar #sirris
)
SendInput,{Raw}%A_space%
Return
:*:trinitytags`t::
...
SendInput,{Raw}
(
22-1042/c40/Digitalisering van productie (Fokus) -
)
SendInput,{Raw}%A_space%
Return
:*:intpro`t::
SendInput,{Raw}
(
22-0235/b50/Interreg-CobotAssist -
)
SendInput,{Raw}%A_space%
Return
:*:ervpro`t::
SendInput,{Raw}
(
22-1489/b50/ErvoProjects(Robberechts), cobotschuren -
)
SendInput,{Raw}%A_space%
Return
:*:twittag`t::
...
SendInput,{Raw}
(
20-0224/c40/Coock COBOFIN - test scannen product, frame transformaties en aansturen robot.
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
Bij vragen of voor bijkomende uitleg, aarzel niet! 
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
#cobot #finishing @sirris #cobofin
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
22-1757,01/c40/Sanha fittings - cobot automatisering montage en verpakking - 
)
SendInput,{Raw}%A_space%
Return
:*:jentry`t::
SendInput,{Raw}
(
	1. Wat heb je vandaag gedaan/geleerd waar je tevreden over bent?
		
	2. Wat heeft iemand anders vandaag gedaan waar je blij over was? Hoe heb je erop gereageerd zodat de kans groot is dat hij/zij dit weet en dat misschien nog eens doet?
		
	3. Wat heb je verder nog geproefd, gevoeld, gezien of gehoord dat je blij maakte?
...
SendInput,{Raw}
(
Sirris is een ongebonden innovatie-centrum met expertise in o.a. industrie 4.0, IOT, data en artificial intelligence , circulaire economie en materialen, 3D printing,...
Ons doel is om bedrijven op een onafhankelijke manier te ondersteunen en het vermijden van een vendor-push in een vroeg stadium. Om dit te realiseren hebben we 160 experten die naast hun ervaring binnen Sirris doorgaans ook een relevante ervaring hebben opgedaan bij technologie- en productiebedrijven. Daarnaast hebben we de beschikking over verschillende application labs waarin we demonstratoren kunnen realiseren aan beperkte kost om kritische zaken te testen . Hiermee kunnen risico's ge-elimineerd worden en een betere inschatting gemaakt worden voor beoogde investeringen.
Sirris heeft uitgebreide ervaring met robots , cobots en automatisatie in het algemeen:
https://www.sirris.be/nl/cobots
https://youtu.be/gdy5v4qmEOM
https://youtu.be/ZxsyoRijKSc?t=7
https://youtu.be/iNAFrpGRiQA?t=11
Daarnaast hebben we recent ervaring opgebouwd rond logistiek in productie-omgevingen (gebruik van AGVs en AMRs):
https://www.sirris.be/production-logistics-40-gaining-momentum-your-company-too
https://www.sirris.be/demo-altachem-shows-potential-amrs-and-agvs
Voorziene experten voor dit project:
)
SendInput,{Raw}%A_space%
Return
:*:mvg`t::
...
SendInput,{Raw}
(
Alvast fijne eindejaarsfeesten en een geweldig 2023 gewenst!
Vriendelijke groeten,
Jan.
)
SendInput,{Raw}%A_space%
...
SendInput,{Raw}
(
Bedankt voor de mooie wensen. Hopelijk alles goed bij ____ en met jou!
Alleszins ook voor jou, je collega's en familie, fijne eindejaarsfeesten en een geweldig 2023 gewenst!
Vriendelijke groeten,
Jan. 
)
SendInput,{Raw}%A_space%
...
SendInput,{Raw}
(
Wishing you happy end-of-year celebrations and a great 2023!
Kind regards,
Jan.
)
SendInput,{Raw}%A_space%
...
SendInput,{Raw}
(
23-1159/c40/TRES-autonoom_voertuig_bovenbouw -
)
SendInput,{Raw}%A_space%
Return
:*:etr`t::
...
SendInput,{Raw}
(
23-1237,01/c40/EuroTapRent, automatisering -
)
SendInput,{Raw}%A_space%
Return
:*:recpro`t::
...
SendInput,{Raw}
(
20-0296,05/c40/EDIH-Walhub_webinarCobots -
)
SendInput,{Raw}%A_space%
Return
:*:madpro`t::
...
SendInput,{Raw}
(
23-1440/c40/Group Nivelles - gieten solid surface23-1440/c40/Group Nivelles - gieten solid surface simulatie -
)
SendInput,{Raw}%A_space%
Return
:*:henpro`t::
SendInput,{Raw}
(
23-1480/c40/Henco, vraag automatisering assemblage nieuw product -
)
SendInput,{Raw}%A_space%
Return
:*:coock`t::
...
SendInput,{Raw}
(
Reconfigurable cOBotic prodUction AsSistanT (ROBUST)
)
SendInput,{Raw}%A_space%
Return
:*:coock+`t::
SendInput,{Raw}
(
Coock+ ROBUST (Reconfigurable cOBotic prodUction AsSistanT)
)
SendInput,{Raw}%A_space%
Return
:*:enquete`t::
...
SendInput,{Raw}
(
23-1581/c40/Heinen Doors - cobots,
)
SendInput,{Raw}%A_space%
Return
:*:cr`t::
...
SendInput,{Raw}
(
C:\Users\ksj\OneDrive - Sirris\ksj_persoonlijk\PortableApps\Q-Dir\Favoriten\projecten.qdr
)
SendInput,{Raw}%A_space%
Return
:*:ppu`t::
...
SendInput,{Raw}
(
23-1203,01/c40/Niko, cobotschuurtest -
)
SendInput,{Raw}%A_space%
Return
:*:arcpro`t::
SendInput,{Raw}
(
2023-1831/c44/Architectural Metals: haalbaarheidsstudie cobot
)
SendInput,{Raw}%A_space%
Return
:*:bgl`t::
...
SendInput,{Raw}
(
2023-1892/c40/Malmar, ondersteuning sturing cobot-LVD
)
SendInput,{Raw}%A_space%
Return
:*:sf`t::
...
SendInput,{Raw}
(
19-0234,11/C40/VLAIO-co-FoF algemeen - master class cobotschuren 
)
SendInput,{Raw}%A_space%
Return
:*:acupro`t::
SendInput,{Raw}
(
Ser-sem-ws-Acumen-20231016-27/c40/08-0843,54 - 
)
SendInput,{Raw}%A_space%
Return
:*:sappro`t::
...
SendInput,{Raw}
(
23-1874,01/c40/Titamed - kwaliteitscontrole 3D printed parts, 
)
SendInput,{Raw}%A_space%
Return
:*:manpro`t::
...
SendInput,{Raw}
(
Moest geen van deze datums passen 
stel dan gerust enkele alternatieven voor.
...
SendInput,{Raw}
(
vlaio-co-FA/C40/Contract Ondernemerschap - master class cobotschuren
)
SendInput,{Raw}%A_space%
Return
:*:hegpro`t::
SendInput,{Raw}
(
23-2168/c40/Hegge, Mogelijkheden cobotschuren -
)
SendInput,{Raw}%A_space%
Return
:*:coorob`t::
...
SendInput,{Raw}
(
t-mst/c40/algemene activiteiten - 
)
SendInput,{Raw}%A_space%
Return
:*:mgtpro`t::
SendInput,{Raw}
(
t-mst-mgt/c40/management activiteiten -
)
SendInput,{Raw}%A_space%
Return
:*:oplpro`t::
SendInput,{Raw}
(
t-mst-learning/c40/deelname aan opleidingen, seminaries, conferenties -
)
SendInput,{Raw}%A_space%
Return
:*:crypro`t::
SendInput,{Raw}
(
t-mst-mgt/c40/management activiteiten - C*
)
SendInput,{Raw}%A_space%
Return
:*:socpro`t::
SendInput,{Raw}
(
t-mst-team/c40/team activiteiten - social-act
)
SendInput,{Raw}%A_space%
Return
:*:teapro`t::
...
SendInput,{Raw}
(
t-mst-atelier-Genk/c40/activiteiten werkplaats
)
SendInput,{Raw}%A_space%
Return
:*:sirrisadr`t::
SendInput,{Raw}
(
Sirris, Thor park 8027 (FacThory), 3600 Genk
)
SendInput,{Raw}%A_space%
Return
:*:beon`t::
...
SendInput,{Raw}
(
2013-0078/C40/t-mst, algemene activiteiten, 
)
SendInput,{Raw}%A_space%
Return
:*:crypro`t::
SendInput,{Raw}
(
2013-0078/C40/t-mst, algemene activiteiten, C*
)
SendInput,{Raw}%A_space%
Return
:*:emapro`t::
SendInput,{Raw}
(
2013-0078/C40/t-mst, algemene activiteiten, e-mail
)
SendInput,{Raw}%A_space%
Return
:*:adbs`t::
...
Kan je voor aanstaande vrijdagmiddag (25/08/2023) broodjes bestellen voor 3 personen voor levering in Diepenbeek?
Projectnr. Is 23-1182
...
SendInput,{Raw}
(
Wie:%A_Tab%Wat:%A_Tab%Waar:%A_Tab%Wanneer:%A_Tab%Waarom:%A_Tab%Hoe:
...
SendInput,{Raw}
(
24-1138/c40/Laborex - robotreiniging, visie, 3dvisie -
)
SendInput,{Raw}%A_space%
Return
:*:acro`t::
...
SendInput,{Raw}
(
24-1019,01/c40/Dana, coaching cobots - 
)
SendInput,{Raw}%A_space%
Return
:*:pm`t::
...
SendInput,{Raw}
(
22-0288/c40/Dig-mgt _efro-pilootlijn - 
)
SendInput,{Raw}%A_space%
Return
:*:vragen`t::
...
SendInput,{Raw}
(
2024-1697,01/c40/Pedeo-schuren met cobot - 
)
SendInput,{Raw}%A_space%
Return
:*:bwa`t::
SendInput,{Raw}
(
Ook van mij de beste wensen voor 2025!
)
SendInput,{Raw}%A_space%
Return
:*:kg`t::
...
SendInput,{Raw}
(
25-1216/c40/Duco - techno-economische haalbaarheidsstudie naar het automatiseren van het beladen/ontladen van een teststation en verpakking
)
SendInput,{Raw}%A_space%
Return
:*:kbg`t::
...
SendInput,{Raw}
(
22-0288,02/c40/Dig-mgt _efro-pilootlijn - 
)
SendInput,{Raw}%A_space%
Return
:*:efrpro`t::
...
SendInput,{Raw}
(
25-1261/c40/Eric Banden, interesse inzetbaarheid humanoid robots,
)
SendInput,{Raw}%A_space%
Return
:*:cobpro`t::
SendInput,{Raw}
(
22-0235,02/b50/Interreg-CobotAssist -
)
SendInput,{Raw}%A_space%
Return
...
SendInput,{Raw}
(
25-1271/c40/CDC - Constructs, cobot finishing, 
)
SendInput,{Raw}%A_space%
Return
:*:adbpro`t::
SendInput,{Raw}
(
2024-1187/c40/ADB Safegate - new layout warehouse and production Project fase 2 - optimalisatie logistieke flows en operaties 
)
SendInput,{Raw}%A_space%
Return
:*:cdc`t::
...
SendInput,{Raw}
(
https://interregvlaned.eu/cobotassist/over-ons
)
SendInput,{Raw}%A_space%
Return
:*:cibpro`t::
...
SendInput,{Raw}
(
Role: your are ,Objective: , Scenario:, Expected outcome: , Steps:
)
SendInput,{Raw}%A_space%
Return
:*:rosesme`t::
SendInput,{Raw}
(
Role: your are me. A consultant for manufacturing companies with expertise in cobots for finishing operations and expertise in flexible automation for high-mix low volume manufacturing in general. ,Objective: , Scenario:, Expected outcome: , Steps:
)
SendInput,{Raw}%A_space%
Return
:*:punpro`t::
SendInput,{Raw}
(
25-1471/c40/punchMetals, cobotschuren -
)
SendInput,{Raw}%A_space%
Return
:*:www`t::
...
SendInput,{Raw}
(
Antwoord op mail in bijlage: Inhoud:
)
SendInput,{Raw}%A_space%
Return
:*:prmail`t::
...
SendInput,{Raw}
(
20-0224/c40/COOCK COBOFIN, rapport 2 jaar na afloop
)
SendInput,{Raw}%A_space%
Return
:*:stapro`t::
SendInput,{Raw}
(
25-1389,01/c40/Stas_OnO_voorbereiding_paprika_knip_oplossing -
)
SendInput,{Raw}%A_space%
Return
:*:nodejs`t::
SendInput,{Raw}
(
docker run --name nodejs -it --rm --entrypoint sh node:22-alpine 
)
SendInput,{Raw}%A_space%
Return
:*:boupro`t::
SendInput,{Raw}
(
25-1551/c40/Boulie - automatiseren, programmeren, connecteren -
)
SendInput,{Raw}%A_space%
Return
:*:cobofinpro`t::
