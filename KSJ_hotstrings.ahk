...
SendRaw,
(
Laat gerust even weten of één van deze voorstellen voor jullie past.
...
SendRaw,
(
Moest één van deze data passen geef dan gerust een uur op dat voor u het best past. 
)
SendRaw, %A_space%
Return
:*:moestgeen`t::
...
SendRaw,
(
18-1018/c40/Glaxo Smith Kline - robots collaboratifs - étude faisabilité dépalletisation -
)
SendRaw, %A_space%
Return
:*:sap`t::
